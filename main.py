...
def get_data() -> tuple:
    client = pygsheets.authorize(service_file="/Users/andrewbatmunkh/Desktop/data/harvest-entry-lyrata-casa-loma-9bfd7a23d7d7.json")
    # open the sheet
    sheet1 = client.open("24-07-29, Casa Loma harvest, Andrew").sheet1
    ...
    sheet2 = client.open("24-07-29, Casa Loma harvest, Andrew").worksheet(
        "index", 1
    )
...
def organize_data(harvest: dict, disease: dict) -> tuple:
    ...
    while i < len(harvest["tier_id"]):
        ...
        print("new_harvesst: ",  new_harvest)
        i += 1
